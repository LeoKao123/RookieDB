...
public enum LockType {
    ...
    public static boolean canBeParentLock(LockType parentLockType, LockType childLockType) {
        ...
        switch(childLockType) {
            ...
            case SIX:
                return parentLockType == IX; // To reduce redundancy,parent cannot be SIX
            case X:
                return parentLockType == IX || parentLockType == SIX;
        }
        return false;
    ...
    public static boolean substitutable(LockType substitute, LockType required) {
        ...
        //  This is only the case if a transaction having substitute can do everything that a transaction having required
        switch(required) {
            case NL:
                return true;
            case S:
